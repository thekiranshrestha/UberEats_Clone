 ...
 * Post like Counter
 * --------------------------------------------------------------------------- */
function uberEats_clone_post_likes_count(admin_url, id, obj) {
  "use strict";

  var dataString = "post_id=" + id + "&action=uberEats_clone_post_likes_count";
...
function uberEats_clone_show_response_theme(loader_data, loading_element) {
  jQuery(".uberEats_clone_loader").hide();
  jQuery("#growls").removeClass("uberEats_clone_element_growl");
  ...
  if (loader_data != "undefined" && loader_data != "") {
    if (loader_data.type != "undefined" && loader_data.type == "error") {
      ...
      if (
        ...
        jQuery("#growls").addClass("uberEats_clone_element_growl");
      }
    } else if (
...
jQuery(document).ready(function ($) {
  if (
    jQuery(".uberEats_clone-fancy-menu li.current-menu-parent a").length > 0
  ) {
    jQuery(".uberEats_clone-fancy-menu li.current-menu-parent a").click();
  } else if (
    jQuery(".uberEats_clone-fancy-menu li").first().children("ul.sub-menu")
      .length > 0
  ) {
    jQuery(".uberEats_clone-fancy-menu li")
      .first()
      .children("ul.sub-menu")
      .slideDown();
    jQuery(".uberEats_clone-fancy-menu li").first().addClass("active");
  }
  /*Back To Top Start*/
